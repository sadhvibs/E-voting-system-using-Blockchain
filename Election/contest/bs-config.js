...
app.get('/vote_area', function (_req, res) {
   res.sendFile( __dirname  + "/src/vote_area.html" );
})

app.get('/candidateDetails', function (_req, res) {
...
app.get('/addCandidate', function (_req, res) {
  res.sendFile( __dirname  + "/src/adminAddCandidate.html" );
})

app.get('/changePhase', function (_req, res) {
  res.sendFile( __dirname  + "/src/adminChangePhase.html" );
})

app.get('/voting', function (_req, res) {
